...
@Service
public class Rule_engine_dev_v1QueryExecutorServiceImpl implements Rule_engine_dev_v1QueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Rule_engine_dev_v1QueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("rule_engine_dev_v1WMQueryExecutor")
