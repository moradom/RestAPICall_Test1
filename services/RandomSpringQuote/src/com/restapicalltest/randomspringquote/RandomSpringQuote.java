...
//import com.restapicalltest.randomspringquote.model.*;
 ...
 */
@ExposeToClient
public class RandomSpringQuote {

    private static final Logger logger = LoggerFactory.getLogger(RandomSpringQuote.class);
    ...
    public Quote getQuote(String baseURL, HttpServletRequest request) {
        logger.debug("Starting sample operation with request url " + request.getRequestURL().toString());
        
        Quote quote = null;
        RestTemplate restTemplate = new RestTemplate();
        quote = restTemplate.getForObject(/*"http://gturnquist-quoters.cfapps.io/api/"*/baseURL+"random", Quote.class);
        logger.debug("Returning {}", quote);
        return quote;
    }
